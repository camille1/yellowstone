...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "http://cdn.edgecommons.org/an/1.1.0/js/min/EdgeCommons.js", user: true },
      { load: "randonees_edge.js"},
      { load: "randonees_edgeActions.js"}];
...
var plSTF="width",ctrPlS="horizontal",minPlW="2px",maxPlW="1000px",plWidth="1070px",plHeight="4351px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['442px', '204px','88px','88px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/preloader5.gif','0px','0px']
    },
    {
        id: 'Text',
        type: 'text',
        rect: ['299px', '69px','402px','102px','auto', 'auto'],
        text: "Merci de patienter durant le chargement",
        align: "center",
        font: ['Verdana, Geneva, sans-serif', 25, "rgba(255,114,0,1.00)", "400", "none", "normal"]
    }]};//simpleContent
